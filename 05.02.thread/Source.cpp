...
int main() {
    ...
    cout << "Время выполнения (один поток): " << chrono::duration<double>(end_time - start_time).count() << " ñåê." << endl;
    ...
    cout << "Время выполнения (многопоточно): " << chrono::duration<double>(end_time - start_time).count() << " ñåê." << endl;
